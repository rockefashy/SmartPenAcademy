export const studentDetailProperties = {
  ...
  section1: {
    ...
    preferredDaysLabel: "Preferred Schedule Days",
    preferredDaysHint: "Select coaching days (1 to 7 days)",
    preferredDaysOptions: ["SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"],
    preferredSlotLabel: "Preferred Time Slot",
